...
IOSButton = function(url)
{
	this.url = "https://itunes.apple.com/gb/app/waste-invaders/id501646532?mt=8";
	...
	this.white = PIXI.Texture.fromFrame("appDownload.png")//FrameId(textureId)// "nav_concW.png");
	this.yellow = PIXI.Texture.fromFrame("appDownloadROLL.png")///FrameId(textureId2)//"nav_concG.png");
...
IOSButton.constructor = IOSButton;
IOSButton.prototype =  Object.create( PIXI.DisplayObjectContainer.prototype );

IOSButton.prototype.select = function()
{
	this.selected = true;
	this.over = true;
	this.tl.play();	
...
IOSButton.prototype.deselect = function()
{
	this.selected = false;
	this.tl.reverse();	
	this.over = false;
...
IOSButton.prototype.onMouseClick = function(event)
{
	if(HIGH)
	{
...
IOSButton.prototype.onMouseOver = function(event)
{
...
IOSButton.prototype.onReachTop = function()
{
	if(this.over)
	{
...
IOSButton.prototype.onMouseOut = function()
{
	if(this.selected)return;
	this.tl.reverse();	
	this.over = false;
...
IOSButton.prototype.updateTransform = function()
{
