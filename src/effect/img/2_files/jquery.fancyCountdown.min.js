...
(function(d) {
    ...
    d.fn.fancyCountdown = function(P) {
        ...
        function g() {
            b.children("div:last").append("<div class='fc-digitUnit fc-width fc-height'><ul class='fc-digits'><li>8</li><li>9</li><li>0</li><li>1</li></ul></div>");
            var c = b.children("div:last").children("div:last").find(".fc-digits li").addClass("fc-height fc-font"),
                h = [];
            digitHeight = d(c[0]).height();
            offsetTop = parseInt(b.children(".fc-digit-offset").css("top"));
            offsetBottom = parseInt(b.children(".fc-digit-offset").css("bottom"));
